...
#ifndef MICRODNS_VERSION_H
#define MICRODNS_VERSION_H

/**
 * @file version.h
 */

#define MICRODNS_VERSION_NAME  "0.0.10"
#define MICRODNS_VERSION_INT   (0<<16 | 0<<8 | 10)
#define MICRODNS_MAJOR         0
#define MICRODNS_MINOR         0
#define MICRODNS_MICRO         10

#endif /* MICRODNS_VERSION_H */
